...
{
    /// <summary>
    /// Visually displays enemy field of view. Automaticaly tries to pick the object from the parent transform.
    /// </summary>
    ...
    public class EnemySight : MonoBehaviour
    {
        ...
        public AIController TargetOverride;
        ...
        private AIController _cachedAIController;
